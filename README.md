# Diabetic_retinopathy_disease_classification using mlflow and DVC
...
'''bash
https://github.com/manjuppatel8572/EndToEndMajorProject 
 
 ### STEP 01- Create a conda environment after opening the repository

```bash
conda create -n diabetic_retinopathy python=3.10 -y
```
